...
ORDER BY COUNT(ist.issued_book_isbn) DESC LIMIT 3;
...
BEGIN
	...
	ELSE
		SELECT CONCAT('SORRY! but book is not available which isbn is : ', p_issued_book_isbn) AS Message;
	END IF;
...
-- 978-0-09-957807-9 - yes  978-0-307-58837-1 - no
