...
SELECT issued_emp_id, count(issued_book_name) as cnt FROM issued_status GROUP BY issued_emp_id HAVING cnt > 1;
...
VALUES 
('C131','Sam','111 Main St', current_date()),
('C132','John','121 Main St', '2026-07-13');
